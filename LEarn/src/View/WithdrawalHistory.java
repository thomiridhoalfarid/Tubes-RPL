...
public class WithdrawalHistory extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jTextField2_Saldo, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 200, 200, 40));
        ...
        jPanel2.add(B_Tarik, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 200, -1, -1));
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 277, 660, 330));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel1.setText("Riwayat Pembayaran");
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 140, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WithdrawalHistory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WithdrawalHistory().setVisible(true);
            }
        });
    }
